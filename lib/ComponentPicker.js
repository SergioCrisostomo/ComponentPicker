    ...
    _createClass(ComponentPicker, [{
        ...
        value: function getElementIndex(hint) {
            ...
            for (var i = 0; i < elements.length; i++) {
                if (typeof hint == 'string' && elements[i].innerHTML != hint) continue;else if (elements[i] != hint) continue;
                index = i;
                break;
            }
            return index;
...
DatePicker.prototype.setValue = function (vals) {
    return this.pickers.map(function (pickers, i) {
...
DatePicker.prototype.onChange = function (callback) {
    ...
    function commonCallback() {
        var values = self.pickers.map(function (picker) {
            return picker.value;
        });
